...
export const EXPLORE_AGENT: AgentDefinition = {
  ...
  buildSystemPrompt: () => [
    ...
    "- If you run out of turns or cannot complete the requested scope, return an INCOMPLETE report explaining exactly what was and was not inspected.",
    "",
    "Final response contract:",
    "- Your final answer must be a structured report, not a progress update.",
    ...
    "## Scope",
    "Briefly restate the assigned scope.",
    "",
