...
import { executeRunCommand, parseRunCliArgs, readRunPrompt, toJsonAgentEvent } from "../../src/repl/run-command.js";
...
const pipedInput = Object.assign(
  ...
  { isTTY: false },
) as unknown as import("../../src/repl/run-command.js").RunPromptInput;
