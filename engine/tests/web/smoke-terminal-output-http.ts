...
// Run: .\node_modules\.bin\tsx.cmd tests/web/smoke-terminal-output-http.ts
import assert from 'node:assert/strict';
import http from 'node:http';
import fs from 'node:fs/promises';
import os from 'node:os';
import path from 'node:path';
import { runWebServer, WebRepl, type WebRuntime } from '../../src/web/index.js';
import { ExecProcessManager, type ExecProcessStartOptions } from '../../src/tools/builtins/exec-process-manager.js';
import { TerminalOutputStore, redactedTerminalChunk, TERMINAL_OUTPUT_RETENTION_MS, type OutputPage, type StoreResult } from '../../src/tools/terminal-output-store.js';
