...
import { createAgentContentDetailResolver, type AgentContentOwner, type AgentContentRequest, type AgentContentPage, type AgentTimelineItem } from '../../src/web/agent-content-detail.js';
