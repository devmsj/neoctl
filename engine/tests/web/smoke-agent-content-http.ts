...
// No production patches. Run: npx tsx tests/web/smoke-agent-content-http.ts
...
import { createLocalAgentTask, type LocalAgentTask } from '../../src/agents/local-agent-task.js';
import { InMemorySecretRedactionRegistry } from '../../src/secrets/secret-redaction.js';
import { redactToolDetail } from '../../src/web/tool-call-detail.js';
import type { AgentContentPage, AgentTimelineItem } from '../../src/web/agent-content-detail.js';
