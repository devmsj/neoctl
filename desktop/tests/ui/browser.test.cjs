// Optional real layout check: node desktop/tests/ui/browser.test.cjs (Windows Edge).
...
(async () => {
  ...
  try {
    ...
    await send('Page.navigate', { url: pathToFileURL(path.join(__dirname, '../../ui/index.html')).href });
